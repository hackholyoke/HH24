    ...
    <>
     <div className="headerContainer">
      ...
      <div className="textContainer">
        ...
        <p> In the heart of the bustling city, where skyscrapers kissed the clouds and streets buzzed with life, there 
            existed a small, hidden garden. This garden, tucked away behind an old, ivy-covered brick wall, was a sanctuary
            of tranquility amidst the urban chaos. Vibrant flowers of every color bloomed year-round, filling the air with 
            their sweet fragrance. Birds sang melodious tunes, and a gentle stream meandered through the lush greenery, it
        </p>
        <p> In the heart of the bustling city, where skyscrapers kissed the clouds and streets buzzed with life, there 
            existed a small, hidden garden. This garden, tucked away behind an old, ivy-covered brick wall, was a sanctuary
            of tranquility amidst the urban chaos. Vibrant flowers of every color bloomed year-round, filling the air with 
