    ...
    <form className='tailWind-form'>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-gray-900">Registration</h2>
          ...
          <br/>
          <br/> <strong>About HackHolyoke 2024</strong>
          <br/>⏱️ November 9th-10th, 2024
          <br/>📍 In-person, Chapin Auditorium
          <br/>
          <br/>Have other questions? Send us an email at hackholyoke@gmail.com.
          </p>
        </div>
